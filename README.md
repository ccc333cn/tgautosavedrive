...
v0.0.34 新增自动归档功能，仅适配 **115 网盘 · 剧迷115会员派送与订阅资源**。

v0.0.37 新增「按季集去重」，默认关闭，可在各剧集类设置中开启并重新预览确认。按接收作品文件夹区分版本，普通版和杜比版各保留一份；只将新派送的同版本重复视频移入115回收站，不替换或删除目标文件，字幕独立归档。
